...
<head>
    ...
    <title>Fetal Movement Chart</title>
</head>
<body>
    ...
    <div class="menu-links">
                ...
                <a href="fmc.php" class="active">Fetal Movement Chart</a>
    ...
    <div class="main-content"> 
        <h1 class="title-box"><span class="title">TITLE</span></h1>
        <div class="white-box">
            <h1>hey</h1>
            <p>hey you back</p>
        </div>
        ...
        <div class="card">
            <div class="card-title" style="font-size: 40px">Hey hey you you</div>
